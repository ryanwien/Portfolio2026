...
cl /nologo /std:c++20 /EHsc /W4 /O2 ..\src\organizer.cpp ..\src\main.cpp /Fe:organize.exe || goto :fail
cl /nologo /std:c++20 /EHsc /W4 /O2 ..\src\organizer.cpp ..\tests\test_organizer.cpp /Fe:tests.exe || goto :fail

echo.
echo Built build\organize.exe and build\tests.exe
popd
exit /b 0
